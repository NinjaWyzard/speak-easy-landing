        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mt-2 mb-6">
              Your Partner in Finding Your Powerful Voice
            </h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                For over 15 years, I've dedicated my career to helping professionals 
                overcome their fear of public speaking and transform into confident, 
                compelling communicators.
              </p>
              <p>
                My approach combines proven techniques from behavioral psychology, 
                theater performance, and executive coaching to create a personalized 
                program that addresses your unique challenges and goals.
              </p>
              <p>
                Whether you're preparing for a crucial board presentation, a wedding 
                toast, or want to become a thought leader in your industry, I'll help 
                you find and amplify your authentic voice.
              </p>
            </div>
